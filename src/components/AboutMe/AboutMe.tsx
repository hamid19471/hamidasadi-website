                ...
                <div className="xl:w-1/2 lg:w-full flex flex-col justify-between gap-[20px]">
                    ...
                    <div>
                        <p className="text-white/80 font-light leading-9 text-justify">
                            Hi!
                            <br /> My name is Hamid who enjoys UI/UX design,
                            website design, and development and has more than 9
                            years of professional experience working as a
                            freelancer. I’m a web designer who can help you to
                            create or improve the styling of any website for you
                            or your company. For me, design is not just doing
                            incredible things, it is about solving a problem and
                            being able to communicate clearly and easily a
                            solution to meet the needs of a user. I love my
                            work, and I am committed to providing my clients
                            with an excellent product, I believe that
                            communication is more than 50% of the design. It has
                            become the key factor in my success as a designer.
                        </p>
                    </div>
